...
module.exports = {
  ...
  plugins: [
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        ".bg-theme-primary-10": {
          backgroundColor: "color-mix(in oklch, var(--color-primary), transparent 90%)",
        },
        ".bg-theme-primary-20": {
          backgroundColor: "color-mix(in oklch, var(--color-primary), transparent 80%)",
        },
        ".bg-theme-primary-30": {
          backgroundColor: "color-mix(in oklch, var(--color-primary), transparent 70%)",
        },
        ".bg-theme-accent-10": {
          backgroundColor: "color-mix(in oklch, var(--color-accent), transparent 90%)",
        },
        ".bg-theme-accent-20": {
          backgroundColor: "color-mix(in oklch, var(--color-accent), transparent 80%)",
        },
        ".bg-theme-accent-30": {
          backgroundColor: "color-mix(in oklch, var(--color-accent), transparent 70%)",
        },
