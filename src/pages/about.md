...
<div class="flex justify-center gap-6 mt-8">
  ...
  <a href="https://www.linkedin.com/in/williamzujkowski"
     class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-200 shadow-md hover:shadow-lg min-h-[64px]"
