...
<div class="bg-linear-to-br from-primary-50 to-indigo-50 dark:from-gray-800/50 dark:to-primary-900/20 p-8 rounded-2xl my-8 shadow-xs border border-primary-100/50 dark:border-primary-800/30">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  ...
  <div class="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl shadow-xs border border-blue-200/50 dark:border-blue-800/30">
  ...
  <div class="bg-linear-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl shadow-xs border border-purple-200/50 dark:border-purple-800/30">
    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
  ...
  <div class="bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-xl shadow-xs border border-green-200/50 dark:border-green-800/30">
    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
  ...
  <div class="bg-linear-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 p-6 rounded-xl shadow-xs border border-red-200/50 dark:border-red-800/30">
    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
...
<div class="bg-linear-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 p-6 rounded-lg border-l-4 border-yellow-400">
...
<div class="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-lg border-l-4 border-blue-400">
  <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center">
...
<div class="bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-lg border-l-4 border-purple-400">
  <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center">
    <span class="text-2xl mr-3">🧬</span>
...
<div class="bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-lg border-l-4 border-green-400">
  <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center">
    <span class="text-2xl mr-3">⚡</span>
    HPC Enablement (2023)
  </h3>
...
<div class="bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-900/20 dark:via-purple-900/20 dark:to-pink-900/20 p-10 rounded-2xl shadow-md my-12 border border-purple-200/50 dark:border-purple-800/30">
...
<div class="bg-linear-to-br from-green-50 via-teal-50 to-emerald-50 dark:from-green-900/20 dark:via-teal-900/20 dark:to-emerald-900/20 p-10 rounded-2xl shadow-lg my-12 border border-green-200/50 dark:border-green-800/30">
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6">
  ...
  <div class="group bg-white dark:bg-gray-800/70 p-6 rounded-xl shadow-xs hover:shadow-md transition-all duration-200 text-center">
    <div class="w-16 h-16 bg-linear-to-br from-blue-100 to-blue-200 dark:from-blue-800 dark:to-blue-900 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
  ...
  <div class="group bg-white dark:bg-gray-800/70 p-6 rounded-xl shadow-xs hover:shadow-md transition-all duration-200 text-center">
    <div class="w-16 h-16 bg-linear-to-br from-purple-100 to-purple-200 dark:from-purple-800 dark:to-purple-900 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
  ...
  <div class="group bg-white dark:bg-gray-800/70 p-6 rounded-xl shadow-xs hover:shadow-md transition-all duration-200 text-center">
    <div class="w-16 h-16 bg-linear-to-br from-red-100 to-red-200 dark:from-red-800 dark:to-red-900 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
  ...
  <div class="group bg-white dark:bg-gray-800/70 p-6 rounded-xl shadow-xs hover:shadow-md transition-all duration-200 text-center">
    <div class="w-16 h-16 bg-linear-to-br from-green-100 to-green-200 dark:from-green-800 dark:to-green-900 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
...
<div class="flex justify-center gap-6 mt-8">
  <a href="https://github.com/williamzujkowski"
    ...
    <svg class="w-6 h-6 mr-3 shrink-0" fill="currentColor" viewBox="0 0 24 24">
...
<div class="bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-8 rounded-xl my-8">
