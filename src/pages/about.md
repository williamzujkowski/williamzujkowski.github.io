...
<div class="flex justify-center gap-6 mt-8">
  <a href="https://github.com/williamzujkowski"
     class="group inline-flex items-center px-8 py-4 bg-gray-800 dark:bg-gray-700 text-white rounded-xl hover:bg-gray-700 dark:hover:bg-gray-600 transition-all duration-200 shadow-md hover:shadow-lg"
  ...
  <a href="https://www.linkedin.com/in/williamzujkowski"
     class="group inline-flex items-center px-8 py-4 bg-blue-600 dark:bg-blue-700 text-white rounded-xl hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-200 shadow-md hover:shadow-lg"
