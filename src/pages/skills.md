...
From AI/ML security to infrastructure automation – skills demonstrated through active open-source projects and real-world implementations.
</p>
...
<div class="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg my-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
      <h4 class="font-medium text-gray-800 dark:text-gray-200 mb-2">Key Technologies</h4>
      <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-1">
        <li>• Model Context Protocol (MCP)</li>
        <li>• Python Package Development</li>
  ...
  <div class="mt-4 text-center">
    <a href="https://github.com/williamzujkowski" class="inline-flex items-center text-purple-600 dark:text-purple-400 hover:underline" rel="noopener noreferrer">
...
<div class="my-6">
  <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">⚡ Security Engineering Focus</h3>
  <div class="space-y-4">
    <div class="flex items-center space-x-4">
      <span class="text-2xl">🔒</span>
      <div class="flex-grow">
        <p class="font-medium text-gray-800 dark:text-gray-200">Supply Chain Security</p>
        <p class="text-sm text-gray-600 dark:text-gray-400">Dependency risk analysis, SBOM generation, license compliance (Dependency Risk Profiler)</p>
      </div>
    </div>
    <div class="flex items-center space-x-4">
      <span class="text-2xl">🤖</span>
      <div class="flex-grow">
        <p class="font-medium text-gray-800 dark:text-gray-200">AI/LLM Security</p>
        <p class="text-sm text-gray-600 dark:text-gray-400">Model Context Protocol implementation, compliance checking (MCP Standards Server)</p>
      </div>
    </div>
    <div class="flex items-center space-x-4">
      <span class="text-2xl">📊</span>
      <div class="flex-grow">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">NIST 800-53r5 automated validation, real-time standards enforcement</p>
      </div>
    </div>
    <div class="flex items-center space-x-4">
      <span class="text-2xl">🛡️</span>
      <div class="flex-grow">
        <p class="font-medium text-gray-800 dark:text-gray-200">Security Operations</p>
        <p class="text-sm text-gray-600 dark:text-gray-400">Alert enrichment systems, vulnerability intelligence pipelines</p>
      </div>
    </div>
  </div>
</div>
