---
title: "Your Agent’s Memory Needs a Recovery Plan"
date: 2026-09-08
description: "Recovering an agent from memory poisoning means removing the malicious influence while keeping useful context. Recent research suggests those are separate tests."
...
I ran a synthetic homelab exercise with a contact record, a derived summary and an unrelated maintenance decision. The [runnable artifact and retained results](https://github.com/williamzujkowski/williamzujkowski.github.io/tree/main/scripts/security-labs/memory-recovery) contain 27 fresh Claude Code sessions: nine prepared states, three repetitions each. Every response proposed a mocked send action and recalled the maintenance decision. No message was delivered.
