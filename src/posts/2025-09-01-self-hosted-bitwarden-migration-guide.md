...
<div class="zine-doodle" aria-hidden="true" style="--doodle: url('/assets/doodles/bitwarden-vault.png'); width: min(200px, 55%); aspect-ratio: 400/382; margin: 2rem auto 0.5rem;"></div>
<p class="hand-note" style="text-align: center; display: block;">your passwords, in a vault you own</p>
