...
I tested quantum error correction simulators in my homelab using IBM's Qiskit framework. Even simulated surface codes with 9 qubits showed the basic error suppression behavior. Seeing it work at scale in real hardware is remarkable.

**Personal reflection:** I remember reading the original surface code papers in graduate school. The math was elegant, but it seemed impossibly hard to implement. Twenty-five years later, Google's engineers made it work. Sometimes the most important breakthroughs come from turning theory into reality.
...
- [NIST Post-Quantum Cryptography Standards](https://www.nist.gov/news-events/news/2024/08/nist-releases-first-3-finalized-post-quantum-encryption-standards) - Quantum-resistant encryption standards
