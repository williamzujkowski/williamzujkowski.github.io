...
date: 2025-09-20
description: Test IoT security with OWASP IoTGoat—practice firmware extraction, API exploitation, and hardware hacking in secure lab environments for vulnerability research.
tags:
- iot
- security
- owasp
