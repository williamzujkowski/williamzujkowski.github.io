...
<div class="zine-doodle" aria-hidden="true" style="--doodle: url('/assets/doodles/secure-code.png'); width: min(200px, 55%); aspect-ratio: 400/455; margin: 2rem auto 0.5rem;"></div>
<p class="hand-note" style="text-align: center; display: block;">the lock, built into the frame</p>
