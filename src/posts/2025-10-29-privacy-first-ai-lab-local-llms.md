...
My Dell R910 hosts the hypervisor with the RTX 3090 passed through to an Ubuntu VM following [container hardening principles](/posts/2025-08-18-docker-lsm-security-hardening). The critical security layer is ensuring the VM can't break out:
...
I configured [Wazuh to monitor AI-specific threats](https://documentation.wazuh.com/) with custom rules to detect suspicious patterns:
...
But I'm not done. The field evolves constantly. [KV cache protection](https://arxiv.org/abs/2409.04040) is on my 2025 roadmap. Better red teaming automation. Implementing [federated RAG for private knowledge bases](https://arxiv.org/abs/2410.13272) to distribute knowledge while maintaining privacy guarantees. There's always more to do.
