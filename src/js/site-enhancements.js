...
function calculateReadingTime() {
  ...
  if (articleContent && readingTimeElement) {
    ...
    const wordCount = text.length > 1000 ? 
...
function initTooltips() {
  ...
  tooltipContainer.className = 'fixed z-50 p-2 bg-gray-light text-text text-xs rounded-github border border-border shadow-md opacity-0 transition-opacity duration-200 pointer-events-none';
