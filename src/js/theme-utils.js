...
export function generateThemeVariables(theme) {
  ...
  const variables = {
    // Primary color scale
    '--color-primary': theme.colors.primaryHue !== undefined ? 
  ...
  // Accent color
  variables['--color-accent'] = theme.colors.accentHue !== undefined ? 
  ...
  Object.assign(variables, {
    ...
    '--shadow-elevated': theme.shadows?.elevated || '0 4px 6px -1px rgba(0, 0, 0, 0.2), 0 2px 4px -2px rgba(0, 0, 0, 0.1)',
 ...
 */
export function generateOklchColor(hue, chroma, lightness) {
 ...
 */
export function parseOklchColor(color) {
